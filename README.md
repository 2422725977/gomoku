...
基于 **Godot 4** 的五子棋图形化对战程序：**棋盘大小（9~19 路）、连珠数（5~6 连）、AI 难度（三档）、执子先后手** 均可实时调节，内置 Alpha-Beta 剪枝 AI，支持悔棋与重新开始。界面采用木色羊皮纸风格，文案全中文。

![游戏截图](docs/screenshot.png)

## 功能

- **可调玩法**：棋盘大小 9~19 路、连珠数 5~6 连、AI 难度 1~3 档，右侧面板实时生效
